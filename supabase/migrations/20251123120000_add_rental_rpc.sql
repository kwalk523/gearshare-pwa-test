-- Function to create a rental request and mark gear as unavailable atomically
-- This bypasses RLS for the update operation since the renter is not the owner
